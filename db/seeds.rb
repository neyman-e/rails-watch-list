...
Movie.create(title: 'The Green mile',
  overview: 'A supernatural bla, bla, bla...',
  poster_url: 'https://pics.filmaffinity.com/the_green_mile-631715339-large.jpg',
  rating: 8.5
)
...
Bookmark.create(comment: 'Recommended', movie_id: 3, list_id: 2)
Bookmark.create(comment: 'Heroes', movie_id: 1, list_id: 3)
Bookmark.create(comment: '11 Oscars', movie_id: 2, list_id: 2)
Bookmark.create(comment: '2020 release', movie_id: 5, list_id: 1)
Bookmark.create(comment: 'Stephen King\'s novel', movie_id: 4, list_id: 3)
